...
public class Exhibit extends IdEntity {
  private static final String DEFAULT_IMG = "/api/file/display/default-img.png";
  private String title;
  private String num;
  @Column(name = "category_id")
  private int categoryId;
  private String description;
  private String img = DEFAULT_IMG;
  ...
  public void setDataWithoutId(Exhibit exhibit) {
    ...
    if (exhibit.img != null && !exhibit.img.equals(DEFAULT_IMG))
